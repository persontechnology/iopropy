...
@section('breadcrumbs', Breadcrumbs::render('noticiaNuevo')) 
@section('acciones')
                        ...
                        <div class="form-group">
                                ...
                                <select class="selectpicker show-tick form-control" name="propiedad"  data-live-search="true" title="Selecione..." data-header="Selecione ">
                                    ...
                                    @foreach($propiedades as $pact)
                                        ...
                                        <option value="{{ $pact->id }}" data-tokens="{{ $pact->codigo }}" data-subtext="{{ $pact->precioEstimado }}" {{ old('propiedad')==$pact->id ? 'selected':'' }}>{{ $pact->codigo }}</option>
                                    @endforeach
