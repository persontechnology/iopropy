                  ...
                  <div class="form-group row">
                    ...
                    <div id="accordion">
                        ...
                        <div class="card">
                          ...
                          <div id="collapseTwo" class="collapse {{ ($errors->has('clave') || $errors->has('password')) ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordion">
                            <div class="card-body">
                              
                                <div class="form-group row">
                                    <label for="clave" class="col-md-3">{{ __('Contraseña antigua') }}</label>
        
                                    <div class="col-md-9">
                                        <input id="clave" type="clave" class="form-control{{ $errors->has('clave') ? ' is-invalid' : '' }}" name="clave" autocomplete="clave">
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-md-3">{{ __('Contraseña nueva') }}</label>
                                ...
                                <div class="form-group row">
                                    <label for="password-confirm" class="col-md-3">{{ __('Confirmar contraseña nueva') }}</label>
