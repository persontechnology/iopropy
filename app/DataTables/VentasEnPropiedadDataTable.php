...
class VentasEnPropiedadDataTable extends DataTable
{
    /**
    ...
    {
        $model=Propiedad::find($this->idPro)->ventas();
    ...
    protected function getColumnsTable()
    {
        return [
            ...
            'medidaTotal',
            'estado',
            'propiedad_id'=>['title'=>'Código propiedad'],
    ...
    {
        return 'VentasEnPropiedad_' . date('YmdHis');
    }
}
